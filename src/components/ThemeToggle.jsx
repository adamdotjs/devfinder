...
const ThemeToggle = () => {
	...
	return (
		<button
			className="flex items-center | gap-3 | text-kashmir hover:text-ebony dark:text-white dark:hover:text-kashmir transition-colors"
			onClick={toggleTheme}
		>
			<span className="uppercase tracking-[2.5px] font-bold leading-none">
				{!theme ? 'dark' : 'light'}
			</span>
			{!theme ? (
				<>
