const UserLinks = ({ user }) => {
	return (
		<div className="grid md:grid-cols-[auto_auto] | gap-y-4 gap-x-8">
			<div
				className={`flex | gap-3 | sm:order-1 | ${user.location ? 'opacity-100' : 'opacity-50'}`}
			>
			...
			<div className={`flex | gap-3 | sm:order-3 | ${user.blog ? 'opacity-100' : 'opacity-50'}`}>
				<svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
					<g fill="currentColor">
